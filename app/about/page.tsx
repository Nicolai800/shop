...
export default function About (){
  return (
    <div className='p-4'>
        About us
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem laboriosam eum nisi quos accusantium in aut, quo, ab repellendus tempora facere, dolorem et. Accusamus vitae fugit iusto qui similique officiis?</p>
